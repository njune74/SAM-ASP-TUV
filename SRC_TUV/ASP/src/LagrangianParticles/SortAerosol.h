...
SUBROUTINE SortAerosolAtGridPointForCoagulation ()
	...
	END DO
        !write(*,*) "L169 END DO WHILE SortAerosol.h"!AD DEBUG
	...
	ELSE
		LocalFlag = .FALSE.
	END IF
        !write(*,*) "L184 SortAerosol.h"!AD DEBUG
...
10	IF (Particle2%Sectional) THEN !!!!!!!!!!!!!!
		...
		IF (.NOT.LocalFlag) THEN
			...
			GOTO 10
		END IF
        !write(*,*) "L202 SortAerosol.h"!AD DEBUG
	ELSE
		LocalFlag = .FALSE.
	END IF
	!write(*,*) "L206 SortAerosol.h"!AD DEBUG
	IF (ASSOCIATED(Particle2%Next) .AND. J .NE. 0) THEN
		Particle1 => Particle2
		Particle2 => Particle2%Next
		GOTO 10
	END IF
        !write(*,*) "L212 SortAerosol.h"!AD DEBUG
...
20	Particle2   => Particle1
	...
	J           =  I
        !write(*,*) "L227 SortAerosol.h"!AD DEBUG
...
30	IF ((Particle1%Edges(2) .GT. Particle3%Edges(1) .AND.							&
		...
		J = J - 1
		IF (J .GT. 0) GOTO 30
	!write(*,*) "L248 SortAerosol.h"!AD DEBUG
	END IF
	...
	IF (J .GT. 1) THEN
		...
		GOTO 30
	END IF
        !write(*,*) "L258 SortAerosol.h" !AD DEBUG
	...
	END IF
        !AD DEBUG
        !write(*,*) "end SortAerosolAtGridPointForCoagulation"
		RETURN
