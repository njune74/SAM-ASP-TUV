...
!MM-DEBUG                        M1, M2, S21, D21, MAXANG )
          ...
          !  for each wavelength (ib)
          IF (ib .eq. 1) THEN                           !MM-DEBUG
            InParticle%ExtEff(ib) = 2.16264817175533
            InParticle%ScaEff(ib) = 1.40012904916431
            InParticle%BackScaEff(ib) = 0.164064222558166
            InParticle%AssymParam(ib) = 1.14116702693286
          ELSE IF (ib .eq. 2) THEN                      !MM-DEBUG
            InParticle%ExtEff(ib) = 2.32247318993286 
            InParticle%ScaEff(ib) = 1.59948556699127 
            InParticle%BackScaEff(ib) = 0.170804274353241 
            InParticle%AssymParam(ib) = 1.30005707193402  
          ELSE IF (ib .eq. 3) THEN                      !MM-DEBUG
            InParticle%ExtEff(ib) = 2.45194152546228  
            InParticle%ScaEff(ib) = 1.78190060435622 
            InParticle%BackScaEff(ib) = 7.684319778497720E-002
            InParticle%AssymParam(ib) = 1.48105473279996 
          ELSE IF (ib .eq. 4) THEN                      !MM-DEBUG
            InParticle%ExtEff(ib) = 2.23494584313351
            InParticle%ScaEff(ib) = 1.60189659086300 
            InParticle%BackScaEff(ib) = 9.727204628906384E-002
            InParticle%AssymParam(ib) = 1.17439435931874 
          ELSE IF (ib .eq. 5) THEN                      !MM-DEBUG
            InParticle%ExtEff(ib) = 2.15863940371425
            InParticle%ScaEff(ib) = 1.57603149711862 
            InParticle%BackScaEff(ib) = 0.196767884028949
            InParticle%AssymParam(ib) = 1.16440286331691 
          ELSE IF (ib .eq. 6) THEN                      !MM-DEBUG    
            InParticle%ExtEff(ib) = 2.50948001666263
            InParticle%ScaEff(ib) = 1.87917853292483 
            InParticle%BackScaEff(ib) = 0.415811891714316 
            InParticle%AssymParam(ib) = 1.36928452755169
          ELSE IF (ib .eq. 7) THEN                      !MM-DEBUG   
            InParticle%ExtEff(ib) = 1.96742202920483 
            InParticle%ScaEff(ib) = 1.32387772141499
            InParticle%BackScaEff(ib) = 0.141952489517718
            InParticle%AssymParam(ib) = 0.778653732891050 
          ELSE                                          !MM-DEBUG
            WRITE(*,*) "ib = ",ib
