...
!MJA 20190617 skip header printout
!      DO i = 1, nhead
!         WRITE(*,*) ahline(i)
!      ENDDO
!      WRITE(*,100) 
...
!MJA 20190617 No reads from standard input as a subroutine
...
* choose input file
 ...
 10   CONTINUE
!MJA 20190617 Hard code inpfil to to "samasp"
...
* confirm or change or get help
 ...
 30   CONTINUE
! MJA 20190617 No reads from standrad input as subroutine
