...
SUBROUTINE SetGasPhaseChemistry ()
	...
	integer	:: FH
        ...
        ! CRL 2018-01-30: Variable to assume the emission factor space is actually EF,
...
10	CurrLine = GetLine(FH)
	...
	write(*,*) 'CO_init = ',CO_init
		...
		write(*,*) 'entered OLDASP loop'
            ...
            ELSE IF (EFASP) THEN!Calculate initial concentration from CO initial concentration and EFs
		write(*,*) 'entered the EF loop'
