...
! Set surface and top fluxes of tracers. Default is 0 set in setdata.f90
 ...
 ! The transport is done automatically. 
  ...
  use Chemistry
      ...
      integer i,j,k,l,ntr,ntrtrack,mm,iup,idown,iden,zden,aerosol_track,binnum,ASP_time,ntrtrack2
      integer :: doAerosols
      ...
      REAL*8 :: TermVel(HowManyEvolveGasChems)
      REAL*8 :: t_TotOA
      ! ---------------------- end from ASP
   ...
   do i=1,nx
      do j=1,ny
		...
		ntrtrack = ntrtrack +1
            ...
            IF (GasConc(2).gt.130.and.nstep.gt.cur_dist) THEN	
            	! Aerosol MassConc
